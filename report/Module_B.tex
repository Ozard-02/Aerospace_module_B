...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{temperature_global.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{temperature_zoomed.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{speedup_plot_loglog.png}
...
We also implemented a OpenMP parallelization for the correct\_he() method, but the results were not satisfactory.
...
We also compared the evolution of species mass fractions over time as presented in Figure \ref{fig:species_pl}.
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{species_plot_0.png}
